namespace Polsolcom.Forms
{
    partial class frmTalonario
    {
        ...
        private void InitializeComponent()
        {
			...
			this.txtCuenta.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmTalonario_KeyDown);
			// 
			// txtNFinal
			// 
			...
			this.txtNFinal.MouseMove += new System.Windows.Forms.MouseEventHandler(this.txtNFinal_MouseMove);
			// 
			// txtNInicial
			// 
			...
			this.txtNInicial.MouseMove += new System.Windows.Forms.MouseEventHandler(this.txtNInicial_MouseMove);
			// 
			// label7
			// 
			...
			this.txtFecha.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmTalonario_KeyDown);
			// 
			// cmbDefault
			// 
			...
			this.cmbDefault.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmTalonario_KeyDown);
			// 
			// label3
			// 
			...
			this.cmbIngresar.KeyDown += new System.Windows.Forms.KeyEventHandler(this.frmTalonario_KeyDown);
			// 
			// frmTalonario
			// 
