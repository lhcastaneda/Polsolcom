...
namespace Polsolcom.Dominio.Reportes {
    ...
    public class rptconpardia : ReportClass {
    ...
    public class Cachedrptconpardia : Component, ICachedReport {
        
        public Cachedrptconpardia() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rptconpardia rpt = new rptconpardia();
            rpt.Site = this.Site;
            return rpt;
        }
